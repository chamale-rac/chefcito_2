...
class FeedRecipeAdapter(options: FirestoreRecyclerOptions<Recipe>) :
        FirestoreRecyclerAdapter<Recipe, FeedRecipeAdapter.RecipeViewHolder>(options) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecipeViewHolder {
        return RecipeViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_post_view, parent, false))
    }
    ...
    override fun onBindViewHolder(holder: RecipeViewHolder, position: Int, model: Recipe) {
        ...
        holder.itemView.setOnClickListener {
            val action = FeedFragmentDirections.actionFeedFragmentToInsideRecipeFragment(model.image, model.title, "feed")
        ...
        holder.save_button.setOnClickListener {
            ...
            current_user?.update("saved_recipes", FieldValue.arrayUnion(model.docId))
